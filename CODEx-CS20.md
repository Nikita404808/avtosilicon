...
| --- | --- | --- |
| `/` | Главная | Hero, «О продукции» (табы), отзывы, новости, бэнд «Доставка/Оплата/Партнёры» |
...
| `/about` | О компании | KPI, факты, блоки о производстве, маркетплейсах, заказе и упаковке |
| `/contacts` | Контакты | Контактные данные, отзыв клиента, карта-заглушка |
| `/info/*` | Доставка, оплата | Аккордеоны/списки FAQ |
...
- Карусели Swiper: отзывы, упаковка на about.
...
- `src/mocks/articles.json` — статьи с тегами (news/reviews).
